using CrudGopi.Data;
using CrudGopi.Models;
using CrudGopi.Models.DBEntities;
using Microsoft.AspNetCore.Mvc;
using Microsoft.IdentityModel.Abstractions;

namespace CrudGopi.Controllers
{
        ...
        public IActionResult Create(EmployeeViewModel employeeData)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    TempData["successMessage"] = "model created is successfully";
            ...
            {
                TempData["errorMessage"] = msg.Message;
                return View();
            }
        }
        ...
        public IActionResult Delete(EmployeeViewModel model)
        {
            try
            {
                ...
                if (employee != null)
                {
                    ...
                    _context.SaveChanges();
                    TempData["successMessage"] = "Delete Message Succesfully";
                    return RedirectToAction("Index");
                }
                else
                {
